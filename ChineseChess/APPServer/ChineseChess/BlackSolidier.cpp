...
CBlackSolidier::CBlackSolidier(char *cColor,int x,CChessBoard *pChessBoard)
{
...
CBlackSolidier::~CBlackSolidier(void)
{
	delete []mAllAccess;
	delete []mCurAccess;
	delete mPosition;
...
void CBlackSolidier::FindCurAccess(char *cColor){
	int x=mPosition->x;
	int y=mPosition->y;
	int iindex=0;
...
void CBlackSolidier::FindAllAccess(char *cColor){
	int iindex=10;
	if(cColor=="Black"){
