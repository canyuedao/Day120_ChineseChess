...
CBlackGun::CBlackGun(char *cColor,int x,CChessBoard *pChessBoard)
{
...
void CBlackGun::FindCurAccess(char *cColor){
	int x=mPosition->x;
	int y=mPosition->y;
...
void CBlackGun::FindAllAccess(char *cColor){	
	int iindex=0;
	for(int i=0;i<9;i++){
		for(int j=0;j<10;j++){
